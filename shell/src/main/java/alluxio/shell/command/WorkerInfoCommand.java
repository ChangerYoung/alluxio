 ...
 */
@ThreadSafe
public final class WorkerInfoCommand extends AbstractShellCommand {
  /**
   * Constructs a new instance to get the worker info list of the {@link FileSystem}.
   *
   * @param fs the filesystem of Alluxio
   */
  public WorkerInfoCommand(FileSystem fs) {
    super(fs);
  }
